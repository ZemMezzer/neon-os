/*
 * NeonOS ZIP build: reader + writer, caller-provided I/O callbacks only.
 * Removed: C++ wrappers, Windows/POSIX stdio paths, file timestamps,
 * zlib-compatible API, and PNG helpers.
 *
 * Original miniz code: public domain / MIT. Keep the upstream notices
 * from the original miniz distribution with this source.
 */
#pragma once
...
MINIZ_EXPORT mz_ulong mz_crc32(mz_ulong crc, const mz_uint8 *ptr, size_t buf_len);
